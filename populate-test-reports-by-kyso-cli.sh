...
KYSO_API=http://localhost:4000/v1 kyso-cli import-github-repository --name jupyter-samples
KYSO_API=http://localhost:4000/v1 kyso-cli import-github-repository --name Kalman-and-Bayesian-Filters-in-Python
KYSO_API=http://localhost:4000/v1 kyso-cli import-github-repository --name notebook-examples