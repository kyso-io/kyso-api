...
export class GithubReposService extends AutowiredService {
  ...
  public async getFileHash(accessToken: string, path: string, githubUsername: string, repositoryName: string, branch: string): Promise<GithubFileHash | GithubFileHash[]> {
