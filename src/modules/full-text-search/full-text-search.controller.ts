    ...
    public async search(
        ...
        const searchResults: FullTextSearchDTO = {
            reports: {
                ...
                organizations: ['lightside', 'darkside'],
                teams: ['protected-team', 'private-team', 'public-team', 'mandalorian-team', 'bobba-fet-book', 'jabba-el-hut-team'],
                tags: ['jedi', 'creed', 'bobba fet', 'jupyter', 'book', 'genome'],
                metadata: {
                    page: 1,
                    pages: 5,
                    perPage: 10,
